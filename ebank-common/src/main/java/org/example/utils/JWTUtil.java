...
public class JWTUtil {
     ...
     */
    private static final long EXPIRE = 1000L * 60 * 60 * 24 * 7 * 20; // 20 week for test

    /**
     * secret for encode
     */
    private static final String SECRET = "ebankbob0902";

    /**
     * token prefix
     */
    private static final String TOKEN_PREFIX = "ebankbob";

    /**
     * subject
     */
    private static final String SUBJECT = "ebank";
